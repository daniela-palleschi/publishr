...
- The **95% CrI can be interpreted directly**: "there is a 95% probability 
the true effect lies between `r b_life_lower` and `r b_life_upper`." A 
frequentist CI does not support this interpretation.
...
- **Do not say "significant."** Instead, describe the posterior: "the credible 
interval excludes zero", "the bulk of the posterior mass is positive", or 
"there is weak/strong evidence for an effect of..."
