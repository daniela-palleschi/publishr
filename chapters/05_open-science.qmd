...
The modular workflow introduced in @sec-modular of the previous chapter — numbered scripts in `R/`, outputs saved to `output/`, manuscript files reading only from `output/` — is a practical implementation of these principles. The rest of Day 2 builds directly on this structure.
...
## Chapter slides
```{=html}
<a href="../slides/05_open_science.html" class="btn btn-outline-primary" target="_blank">
  Open slides ↗
</a>
```