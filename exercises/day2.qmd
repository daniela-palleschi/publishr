...
Then use inline code to fill in the following sentence. First store the values 
as named objects in a hidden chunk, then reference them inline:

```
There was no effect of tense (β = ___, SE = ___, *t* = ___, *p* ___).
```
...
### Exercise 3: Fit a total reading time model
...
### Exercise 4: Report the total reading time model in your manuscript
